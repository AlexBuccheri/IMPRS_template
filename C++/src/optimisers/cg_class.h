#ifndef IMPRS_CG_CLASS_H
#define IMPRS_CG_CLASS_H
...
namespace optimiser::armadillo::cg{
    ...
    namespace nonlinear{
        // Use BFGS as a reference
        class NLCG: public NonLinearCGBase{
        private:
            // TODO Add private data, not present in the base class

            // TODO Declare the method prototypes
        public:
    ...
    namespace bfgs{
         ...
         * @see NonLinearCG
         */
        class BFGS: public NonLinearCGBase{
