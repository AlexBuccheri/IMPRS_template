...
import numpy as np
from IMPRSPython.finite_difference import central_difference
...
def test_derivative_rosenbrock():
    ...
    assert np.allclose(grad_analytic, np.array([0., 0.])), \
        "Evaluating F at its minimum should give zero gradient"
